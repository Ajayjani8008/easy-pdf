    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-8 text-center mb-8">
            ...
            <p class="text-blue-700 mb-6">
                We're working hard to bring you this amazing tool. It will be available very soon with all the features you need.
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                <div class="w-10 h-10 mb-4">
                    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
                        <rect x="8" y="8" width="32" height="32" rx="4" fill="{{ $feature['color'] }}" />
        ...
        <div class="bg-gray-50 rounded-xl p-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center">Try Our Other Tools</h2>
